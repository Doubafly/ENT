...
// export default function AdminProfil({ user }: { user: any }) {
...
//     type: user.type || "",
//     nouveau_mot_de_passe: "", // champ utilisé pour changer
//   });
...
//     const mot_de_passe = formData.nouveau_mot_de_passe.trim()
//       ? formData.nouveau_mot_de_passe // nouveau mot de passe à hasher
//       : user.password; // ancien déjà hashé
...
//         ? [
//             user.permissions.enseignants,
//             user.permissions.etudiants,
//             user.permissions.admin,
//             user.permissions.classes,
//             user.permissions.paiement,
//             user.permissions.note,
//             user.permissions.emplois_du_temps,
//             user.permissions.parametres,
//             user.permissions.annonces,
//           ]
//         : [],
//     };

//     console.log("Données envoyées :", payload);
//     // Tu peux envoyer avec fetch ici
//   };
...
//             className="mr-2"
//           />
//           <label className="text-gray-700">Est administrateur</label>
//         </div>
...
//             {user.permissions &&
//               Object.entries(user.permissions).map(([key, value]: any) => (
//                 <li key={key}>
//                   {key} : {value ? "✔️" : "❌"}
//                 </li>
//               ))}
...
//           className="bg-blue-500 text-white rounded-md py-2 px-4 hover:bg-blue-600 w-full"
//         >
//           Enregistrer
//         </button>
//       </div>
