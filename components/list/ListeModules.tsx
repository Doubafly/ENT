...
const ListeModules = () => {
  const [modules, setModules] = useState([
    { id: 1, nom: "Mathématiques", code_module: "MATH101", description: "Algèbre et Analyse", credits: 6, volumeHoraire: 45 },
    { id: 2, nom: "Programmation", code_module: "INFO102", description: "Programmation en C", credits: 4, volumeHoraire: 30 },
    { id: 3, nom: "Base de Données", code_module: "INFO201", description: "SQL et Modélisation", credits: 5, volumeHoraire: 40 },
    { id: 4, nom: "Réseaux", code_module: "INFO301", description: "Réseaux Informatiques", credits: 5, volumeHoraire: 40 },
    { id: 5, nom: "Système d'exploitation", code_module: "INFO202", description: "Gestion des systèmes", credits: 4, volumeHoraire: 35 },
    { id: 6, nom: "Sécurité", code_module: "INFO402", description: "Sécurité informatique", credits: 6, volumeHoraire: 50 },
    { id: 7, nom: "Algorithmique", code_module: "MATH202", description: "Algorithmes avancés", credits: 4, volumeHoraire: 30 },
    { id: 8, nom: "Cloud Computing", code_module: "INFO502", description: "Introduction au Cloud", credits: 4, volumeHoraire: 40 }
  ]);
          ...
          <table className="w-full border border-gray-300 rounded-lg">
            ...
            <tbody>
              {currentModules.map((module) => (
                <tr
                  key={module.id}
                  className={`cursor-pointer border-b ${selectedModule?.id === module.id ? "bg-blue-200" : "hover:bg-gray-100"}`}
      ...
      <div className="w-1/6 flex flex-col items-start space-y-4 mt-10 ml-auto">
        ...
        <button
          className={`w-full px-3 py-1.5 rounded-lg flex items-center justify-center text-sm ${
            selectedModule ? "bg-yellow-600 text-white hover:bg-yellow-700" : "bg-gray-400 text-gray-600 cursor-not-allowed"
          }`}
        ...
        <button
          className={`w-full px-3 py-1.5 rounded-lg flex items-center justify-center text-sm ${
            selectedModule ? "bg-red-600 text-white hover:bg-red-700" : "bg-gray-400 text-gray-600 cursor-not-allowed"
          }`}
          disabled={!selectedModule}
