...
export default function EnseignantList() {
  ...
  const [selectedEnseigant, setSelectedEnseignant] = useState<User | null>(
    null
  ); // État pour gérer l'affichage du modal
  ...
  return (
    <div className="ml-0 px-1 py-5 text-xl">
      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grig-cols-6 gap-6 p-6">
